...
# ═══════════════════════════════════════════════════════════════════════════════
# PWA ROUTES - Serve dashboard and static files
# ═══════════════════════════════════════════════════════════════════════════════

@app.route('/')
def serve_dashboard():
    """Serve the main PWA dashboard"""
...
def serve_icon_192():
    ...
    return send_from_directory(os.path.join(BASE_DIR, 'static'), 'icon-192.png', mimetype='image/png')

@app.route('/icon-512.png')
def serve_icon_512():
    """Serve PWA icon 512x512"""
    return send_from_directory(os.path.join(BASE_DIR, 'static'), 'icon-512.png', mimetype='image/png')

@app.route('/health')
def health_check():
    """Health check endpoint for cloud platforms"""
    return jsonify({'status': 'healthy', 'version': '8.2', 'service': 'mega-forex-pwa'})
...
if __name__ == '__main__':
    print("=" * 70)
    print("         MEGA FOREX v8.2 PRO - PWA CLOUD EDITION")
    print("=" * 70)
    ...
    # Run the app (for local development only - production uses gunicorn)
